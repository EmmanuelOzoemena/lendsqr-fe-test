    ...
    <div className="login">
      <div className="login__left">
        ...
        <div className="login__illustration">
          <img src={Illustration} alt="sign-in image" />
        </div>
      </div>

      <div className="login__right">
        <div className="login__form-wrapper">
          <h2 className="login__form-wrapper__title">Welcome.</h2>
          <p className="login__form-wrapper__sub-title">Enter details to login.</p>
